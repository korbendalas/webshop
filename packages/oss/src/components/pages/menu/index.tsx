    ...
    <div className={classes.root}>
      ...
      >
        ...
        <List>
          ...
          >
            <ListItem button>
              <ListItemIcon>{open ? <InboxIcon /> : <MailIcon />}</ListItemIcon>
              <ListItemText primary="Dashboard" />
            </ListItem>
          </NavLink>
          <CollapseMenuItem itemName="Products" routes={productRoutes} menuToggle={open} />
          <CollapseMenuItem itemName="Users" routes={userRoutes} menuToggle={open} />
        </List>
      </Drawer>
